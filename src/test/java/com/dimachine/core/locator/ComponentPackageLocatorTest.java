...
public class ComponentPackageLocatorTest {
    ...
    public void whenGivenAnEmptyList_shouldReturnEmptyPackageList() {
        ...
        List<String> locatedPackages = locator.locate(List.of());

        assertEquals(0, locatedPackages.size());
    }
    ...
    public void shouldBeAbleToReadComponentScanAnnotationWithSingleValue() {
        ...
        List<String> locatedPackages = locator.locate(List.of(SinglePackageConfig.class));

        assertEquals(List.of("com.example"), locatedPackages);
    }
    ...
    public void shouldBeAbleToReadComponentScanAnnotationWithBasePackagesAttribute() {
        ...
        List<String> locatedPackages = locator.locate(List.of(BasePackagesConfig.class));

        assertEquals(Set.of("com.example", "evil.inc"), new HashSet<>(locatedPackages));
    }
    ...
    public void shouldBeAbleToReadComponentScanAnnotationWithTypeSafeBasePackagesAttribute() {
        ...
        List<String> locatedPackages = locator.locate(List.of(TypeSafeBasePackagesConfig.class));

        assertEquals(Set.of("java.lang", "java.util"), new HashSet<>(locatedPackages));
    }
    ...
    public void shouldBeAbleToReadComponentScanAnnotationWithAllAttributesPresent() {
        ...
        List<String> locatedPackages = locator.locate(List.of(CombinedAttributesConfig.class));

        assertEquals(Set.of("java.lang", "java.util", "com.example", "evil.inc"), new HashSet<>(locatedPackages));
    }
    ...
    public void shouldBeAbleToReadRepeatedComponentScanAnnotation() {
        ...
        List<String> locatedPackages = locator.locate(List.of(RepeatablePackagesConfig.class));
